...
check "custom agent-tools port is preserved" grep -qx '  listen: { host: 127.0.0.1, port: 8631 }' /mnt/config/service.yml
...
check "custom-path s6 longrun stays up, stops cleanly, and restarts" ./check-longrun.sh
